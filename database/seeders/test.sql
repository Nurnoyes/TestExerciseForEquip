...
CREATE INDEX id_product ON prices (id_product);

/* SQLINES DEMO *** le `prices` */
...
/* SQLINES DEMO *** for table `products` */
...
CREATE INDEX id_group ON products (id_group);
